const sonic = {
    ...
    titulosJuegos: ["Sonic Unleashed", "Sonic Colours", "Sonic Adventure 2"],
...
const shadow = {
    ...
    titulosJuegos: ["Adventure 2", "Shadow The Hedgehog 2005", "Generations"],

    imagenTarjeta: "img/shadow_foda-removebg-preview.pngf",
    icon: "img/shadowpeque.png",
    imgGameplay:"img/Shadow-S2.jpeg", 
